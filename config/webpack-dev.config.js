...
module.exports = {
   ...
   //入口文件
    entry:  {
        ...
        bundle:['react-hot-loader/patch',rootPath + appPath +'main.js']
    },
    //输出文件目录，名称
    output: {
        path: rootPath + '/dist',
        filename: '[name].js',
        chunkFilename: '[name].[chunkhash:5].chunk.js',  //按需加载出文件
    },
        ...
        rules: [
            ...
            },
            {
             ...
             {   
                ...
                loader: extractTextPlugin.extract({
                  fallback: "style-loader",
                  use: "css-loader!postcss-loader" //css3自动补充
                })
            },
            {
                test: /\.less$/,
            ...
            },
            {
                ...
                loaders: [
                    ...
                    // 'image-webpack-loader?bypassOnDebug&optimizationLevel=7&interlaced=false'//图片压缩
                ]
            }
        ]
    },
    plugins: [
        ...
        new htmlWebpackPlugin({
            ...
            inject:'body',
            hash:false,    //为静态资源生成hash值,如bundle.js?22b9692e22e7be37b57e
            minify:{    //压缩HTML文件
